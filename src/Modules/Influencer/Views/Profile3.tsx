            ...
            <div>
                ...
                <div className="flex">
                    ...
                    <div className=" pt-1">
                        <div  className=" justify-end">
                            ...
                            <button className=" text-blue-500 border border-hidden bg-slate-500 bg-opacity-10 py-[10px] px-[12px] ml-[17px] rounded-3xl">Travel & Tourism</button>
                        </div>
                    </div>
                ...
                <div className="w-96 h-80 mt-11 flex-col justify-start items-start gap-6 inline-flex">
                    <div className="flex-col justify-start items-start gap-2 flex">
                        ...
                        <div className="w-[696px] h-[450px] mt-[53px] relative">
                            <div className="px-12 py-2 left-0 top-0 absolute rounded-xl justify-start items-start gap-16 inline-flex">
                                ...
                                <div className="flex-col justify-start items-center inline-flex">
                                    <div className="text-black text-xl font-medium tracking-wide">Posts</div>
                                    <div className=" justify-center w-[24px] h-[2px] bg-black"/>
                                </div>
                                <div className="flex-col justify-start items-center inline-flex">
                                    <div className="text-neutral-600 text-xl font-medium tracking-wide">Reels</div>
                                </div>
                            </div>
                            <div className="w-72 h-80 left-[56px] top-[89px] absolute">
                                <img className="w-72 h-80 left-0 top-0 absolute" src="./../Images/pizza 1.png" />
                                <div className="w-72 h-80 left-0 top-0 absolute bg-black bg-opacity-25" />
                                <div className="w-4 h-4 left-[102px] top-[283px] absolute" />
                                <div className="w-12 h-4 left-[25px] top-[291px] absolute justify-center items-center gap-1.5 inline-flex">
                                    <div className="w-4 h-4 relative">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
                                            <path d="M8.00016 14.4346C7.7935 14.4346 7.5935 14.4079 7.42683 14.3479C4.88016 13.4746 0.833496 10.3746 0.833496 5.79457C0.833496 3.46124 2.72016 1.56791 5.04016 1.56791C6.16683 1.56791 7.22016 2.00791 8.00016 2.79457C8.38738 2.40382 8.84856 2.09409 9.35677 1.88348C9.86498 1.67288 10.41 1.5656 10.9602 1.56791C13.2802 1.56791 15.1668 3.46791 15.1668 5.79457C15.1668 10.3812 11.1202 13.4746 8.5735 14.3479C8.40683 14.4079 8.20683 14.4346 8.00016 14.4346ZM5.04016 2.56791C3.2735 2.56791 1.8335 4.01457 1.8335 5.79457C1.8335 10.3479 6.2135 12.8812 7.7535 13.4079C7.8735 13.4479 8.1335 13.4479 8.2535 13.4079C9.78683 12.8812 14.1735 10.3546 14.1735 5.79457C14.1735 4.01457 12.7335 2.56791 10.9668 2.56791C9.9535 2.56791 9.0135 3.04124 8.40683 3.86124C8.22016 4.11457 7.7935 4.11457 7.60683 3.86124C7.31059 3.45929 6.92386 3.13275 6.47795 2.90806C6.03204 2.68337 5.53948 2.56684 5.04016 2.56791Z" fill="white"/>
                                        </svg>
                                    </div>
                                    <div className="text-white text-xs font-medium tracking-wide">25.3K</div>
                                </div>
                                <div className="w-12 h-3.5 left-[93px] top-[291px] absolute justify-start items-center gap-1.5 inline-flex">
                                    <div className="w-3.5 h-3.5 relative">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none">
                                            <path d="M7.16667 14.6868C6.70667 14.6868 6.27333 14.4535 5.96667 14.0468L4.96667 12.7135C4.9282 12.6809 4.88248 12.658 4.83333 12.6468H4.5C1.72 12.6468 0 11.8935 0 8.14681V4.81348C0 1.86681 1.55333 0.313477 4.5 0.313477H9.83333C12.78 0.313477 14.3333 1.86681 14.3333 4.81348V8.14681C14.3333 11.0935 12.78 12.6468 9.83333 12.6468H9.5C9.44667 12.6468 9.4 12.6735 9.36667 12.7135L8.36667 14.0468C8.06 14.4535 7.62667 14.6868 7.16667 14.6868ZM4.5 1.31348C2.11333 1.31348 1 2.42681 1 4.81348V8.14681C1 11.1601 2.03333 11.6468 4.5 11.6468H4.83333C5.17333 11.6468 5.56 11.8401 5.76667 12.1135L6.76667 13.4468C7 13.7535 7.33333 13.7535 7.56667 13.4468L8.56667 12.1135C8.78667 11.8201 9.13333 11.6468 9.5 11.6468H9.83333C12.22 11.6468 13.3333 10.5335 13.3333 8.14681V4.81348C13.3333 2.42681 12.22 1.31348 9.83333 1.31348H4.5Z" fill="white"/>
                                            <path d="M10.4997 5.31348H3.83301C3.55967 5.31348 3.33301 5.08681 3.33301 4.81348C3.33301 4.54014 3.55967 4.31348 3.83301 4.31348H10.4997C10.773 4.31348 10.9997 4.54014 10.9997 4.81348C10.9997 5.08681 10.773 5.31348 10.4997 5.31348ZM7.83301 8.64681H3.83301C3.55967 8.64681 3.33301 8.42014 3.33301 8.14681C3.33301 7.87348 3.55967 7.64681 3.83301 7.64681H7.83301C8.10634 7.64681 8.33301 7.87348 8.33301 8.14681C8.33301 8.42014 8.10634 8.64681 7.83301 8.64681Z" fill="white"/>
                                        </svg>
                                    </div>
                                    <div className="text-white text-xs font-medium tracking-wide">25.3K</div>
                                </div>
                                <div className="w-64 h-7 left-[24px] top-[257px] absolute text-white text-xs font-medium tracking-tight">Discover the world's tech secrets with I'm CheCo Tech!</div>
                            </div>
                            <div className="w-96 h-80 left-[378px] top-[89px] absolute">
                                <img className="w-72 h-80 left-0 top-0 absolute" src="./../Images/pizza 1.png" />
                                <div className="w-72 h-80 left-0 top-0 absolute bg-black bg-opacity-25" />
                                <div className="w-4 h-4 left-[102px] top-[283px] absolute" />
                                <div className="w-12 h-4 left-[25px] top-[291px] absolute justify-center items-center gap-1.5 inline-flex">
                                ...
                                <div className="w-64 h-7 left-[24px] top-[257px] absolute text-white text-xs font-medium tracking-tight">Discover the world's tech secrets with I'm CheCo Tech!</div>
                                <div className="w-72 h-80 left-[321px] top-0 absolute">
                                    <img className="w-72 h-80 left-0 top-0 absolute" src="./../Images/pizza 1.png" />
                                    <div className="w-72 h-80 left-0 top-0 absolute bg-black bg-opacity-25" />
                                    <div className="w-4 h-4 left-[102px] top-[283px] absolute" />
                                    <div className="w-12 h-4 left-[25px] top-[291px] absolute justify-center items-center gap-1.5 inline-flex">
